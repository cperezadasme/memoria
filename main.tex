...
\newcommand{\titulo}{Privacidad Diferencial: Algoritmos para Garantizar Privacidad en Bases de Datos de Grafos}
\newcommand{\ciudad}{Santiago} % e.g. Valparaíso
% TODO: Consultar el formato de los nombres:
\newcommand{\nombrealumno}{Constanza de Lourdes Pérez Adasme}
\newcommand{\nombreprofesor}{Carlos Buil Aranda}
\newcommand{\nombrecorreferente}{}
